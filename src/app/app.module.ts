...
@NgModule({
  declarations: [AppComponent, AllDataComponent, AddStudentComponent, EditStudentComponent, DeleteDialogStudentComponent, DeleteDialogProductComponent, ViewStudentComponent, ViewProductComponent, EditProductComponent, AddProductComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
